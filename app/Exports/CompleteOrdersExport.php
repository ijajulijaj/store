...
class CompleteOrdersExport implements FromCollection, WithHeadings
{
    private $start_date;
    private $end_date;
    private $user_type;
    ...
    public function collection()
    {
        $orders = DB::table('order_detail as od')
            ...
            ->where('od.order_status', 3) // ✅ completed orders only
            ->whereBetween(DB::raw('DATE(od.created_date)'), [$this->start_date, $this->end_date]);

        // ✅ Restrict outlet users (user_type = 2)
        ...
        $orders = $orders->map(function ($order) {
            ...
            if ($diffInSeconds > $eightHoursInSeconds) {
            ...
            // ✅ Convert payment_type to readable text
            ...
            return [
                ...
                'payment_type'    => $paymentTypeText, // ✅ updated
