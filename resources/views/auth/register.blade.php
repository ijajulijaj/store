...
<head>
  ...
  <title>Agora - Inventory - Admin Registration</title>
          ...
          <div class="card-body p-0">
            <div class="row">
              <div class="col-lg-6 d-none d-lg-flex align-items-center justify-content-center">
                <img src="{{ asset('public/admin_assets/img/logo.png') }}" alt="profile Pic" class="custom-image-size left-center">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form action="{{ route('register.save') }}" method="POST" class="user">
                    ...
                    <div class="form-group">
                      <input name="user_id" type="text" class="form-control form-control-user @error('user_id')is-invalid @enderror" id="exampleInputUserId" placeholder="User ID">
                      @error('user_id')
                        <span class="invalid-feedback">{{ $message }}</span>
                      @enderror
                    </div>
                    <div class="form-group">
                      <input name="full_name" type="text" class="form-control form-control-user @error('full_name')is-invalid @enderror" id="exampleInputFullName" placeholder="Full Name">
                      @error('full_name')
                        <span class="invalid-feedback">{{ $message }}</span>
                      @enderror
                    </div>
