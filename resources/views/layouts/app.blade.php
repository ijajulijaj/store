...
<head>
  ...
  <link href="{{ asset('public/admin_assets/vendor/fontawesome-free/css/sb-admin-2.min.css') }}" rel="stylesheet">
  ...
  <link href="{{ asset('public/admin_assets/css/bootstrap-datepicker.min.css') }}" rel="stylesheet">
  ...
  <!-- Page level custom scripts -->
  <script src="{{ asset('public/admin_assets/js/demo/bootstrap-datepicker.min.js') }}"></script>

  @yield('scripts') <!-- Add this line to include page-specific scripts -->
